...
int luary_fxyzw_mk(lulog *log, luary_fxyzw **fxyzw, size_t n);
/// Free an array of (x,y,z,w) float tuples.
int luary_fxyzw_free(luary_fxyzw **fxyzw, int prev_status);
/// Allocate space in an array of (x,y,z,w) float tuples.
int luary_fxyzw_res(lulog *log, luary_fxyzw *fxyzw, size_t n);
...
int luary_fxyzw_dump(lulog *log, luary_fxyzw *fxyzw, const char *name, size_t nlines);
