...
int lustr_print(lulog *log, lustr *str, const char *format);
int lustr_nprint(lulog *log, lustr *str, int max_size, const char *format);
...
int lustr_nappend(lulog *log, lustr *str, int max_size, const char *format);
